...
| 4 | GUI 候補機能の再読 | 第1巡の比較メモと Phase8 backlog 素案まで到達 | [docs/specs/gui/gui-phase7-workstream4-gui-candidate-recheck.md](docs/specs/gui/gui-phase7-workstream4-gui-candidate-recheck.md) |
