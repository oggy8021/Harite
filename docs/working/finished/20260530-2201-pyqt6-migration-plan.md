...
- [feature-overview](20260518-2047-feature-overview.md) の C-04（GUI 利用導線の再設計）と密接に関連する。
...
- Feature overview（完了アーカイブ）: [20260518-2047-feature-overview.md](20260518-2047-feature-overview.md) / active: [20260609](../../20260609-1200-feature-overview.md)
