...
| C-01 | 外部壁紙サイト連携 | 外部サイトや API から壁紙候補を取得し、Harite の source として扱えるようにする。C-05 の local/mounted source 扱いを一種の先行試行とみなせる。オーナー発案の本丸 feature。 | **spec 段 1b** — 1a #388 済、[§12–16](../specs/source/harite-source-spec.md)、§15 気象庁 |
...
[完了] C-05  slideshow source 強化   ← #382–384, audit: [20260602-c05-3layer-audit.md](finished/20260602-c05-3layer-audit.md)
         ↓
        C-01  外部壁紙サイト連携   ← 1a #388 済、spec 1b（気象庁）
...
- 2026-06-03: 第4波 **C-01 spec 1a 完了**（#388）— 次 spec 1b（気象庁 §15）
