...
def _main_aliases(w: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "cmbDisplayScaleL": _get("combo_display_scale_l"),
        "btnClrPathL": _get("btn_clr_path_l"),
        "entPathR": _get("input_display_r"),
        "cmbDisplayScaleR": _get("combo_display_scale_r"),
        ...
        "boxApplySection": _get("apply_group"),
...
def _dialog_aliases(w: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "spnSettingsCanvasScale": _get("prefs_canvas_scale_spin"),
