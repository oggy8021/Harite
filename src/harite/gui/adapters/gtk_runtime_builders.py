...
def _set_xalign_if_supported(widget: Any, value: float = 0.0) -> None:
...
def build_header_section(gtk_module: Any, root: Any) -> dict[str, Any]:
    ...
    _set_xalign_if_supported(command_section_label)
    ...
    _set_xalign_if_supported(flow_legend_label)
...
def build_action_cluster_section(gtk_module: Any, compose_grid: Any, *, default_apply_mode: str) -> dict[str, Any]:
    ...
    _set_xalign_if_supported(optimize_section_label)
    ...
    _set_xalign_if_supported(apply_target)
    ...
    _set_xalign_if_supported(apply_mode_label)
    ...
    _set_xalign_if_supported(preview_section_label)
    ...
    _set_xalign_if_supported(preview_left_assignment)
    ...
    _set_xalign_if_supported(preview_right_assignment)
    ...
    _set_xalign_if_supported(preview_left_result)
    ...
    _set_xalign_if_supported(preview_right_result)
...
def build_watch_tab_section(gtk_module: Any, *, configure_spin_button: Any) -> dict[str, Any]:
    ...
    _set_xalign_if_supported(watch_label)
    watch_tab_title = gtk_module.Label(label="Watch (stopped)")
    _set_xalign_if_supported(watch_tab_title)
    ...
    _set_xalign_if_supported(watch_sources_label)
...
def build_margins_tab_section(
    ...
    *,
    ...
    _set_xalign_if_supported(margins_section_label)
    ...
    _set_xalign_if_supported(current_state_title_display)
    current_state_summary_display = gtk_module.Label(label="align=center,center/center,center")
    _set_xalign_if_supported(current_state_summary_display)
    ...
    _set_xalign_if_supported(right_margin_label)
    ...
    _set_xalign_if_supported(bottom_margin_label)
    ...
    _set_xalign_if_supported(margin_text_mode_label)
    ...
    _set_xalign_if_supported(margin_settings_preview_label)
    ...
    _set_xalign_if_supported(margin_text_section_label)
    ...
    _set_xalign_if_supported(margin_position_label)
    ...
    _set_xalign_if_supported(margin_position_left_label)
    ...
    _set_xalign_if_supported(margin_position_right_label)
    ...
    _set_xalign_if_supported(margin_text_hint)
    ...
    _set_xalign_if_supported(margins_tab_title)
