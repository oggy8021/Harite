...
RUNTIME_HANDLER_MAP: dict[str, str] = {
    ...
    "on_change_embed_info": "on_change_embed_info",
    "on_change_embed_text": "on_change_embed_text",
    "on_change_embed_position": "on_change_embed_position",
    "on_change_embed_max_lines": "on_change_embed_max_lines",
